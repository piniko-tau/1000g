...
#add alt gene here
            cur.execute("select gene_name||' | '||rsids||' | '||gene_drugs from %s group by gene_name order by gene_name;",(AsIs(table_mind_export_ml_with_drugs_alt_header_rsids_and_drugs),))
