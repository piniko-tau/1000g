...
def transpose_file_2_file(file2_transpose, transposed_file):
    ...
    with open (transposed_file, "a") as t2:
        ...
        for i in pbar(range(-1,row_length,50)):
